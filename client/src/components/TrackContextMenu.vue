  ...
  <Teleport to="body">
    ...
    <Transition name="sheet">
      ...
      >
        ...
        <button
          class="flex min-h-12 items-center gap-3 w-full rounded-lg px-3 py-3 text-left text-sm hover:bg-zinc-800 transition-colors"
          @click="onPlayNext"
        >
        ...
        <button
          v-if="playlistId"
          class="flex min-h-12 items-center gap-3 w-full rounded-lg px-3 py-3 text-left text-sm text-red-400 hover:bg-zinc-800 transition-colors"
