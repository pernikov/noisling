    ...
    <section>
      ...
      <div v-if="loadingRecent" class="animate-pulse">
        ...
        <div class="hidden sm:block">
          <div class="grid grid-cols-[2rem,minmax(0,1fr),minmax(0,18%),minmax(0,18%),4rem,6rem,1rem,4rem] items-center gap-x-3 px-1 py-2 border-b border-zinc-800">
          ...
          <div v-for="i in 5" :key="`desktop-${i}`" class="grid grid-cols-[2rem,minmax(0,1fr),minmax(0,18%),minmax(0,18%),4rem,6rem,1rem,4rem] items-center gap-x-3 px-1 py-2">
